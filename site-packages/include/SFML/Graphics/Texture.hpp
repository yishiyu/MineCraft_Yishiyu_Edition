...
public:
    ...
    enum CoordinateType
    {
        Normalized, ///< Textures coordinates in range [0 .. 1]
        Pixels      ///< Textures coordinates in range [0 .. size]
    };
...
public:
    ...
    /// mix sf::Textures with OpenGL code.
    ///
    /// \code
    /// sf::Textures t1, t2;
    /// ...
...
/// \ingroup graphics
///
/// sf::Textures stores pixels that can be drawn, with a sprite
...
/// to the texture in a single operation (see Textures::update).
///
/// sf::Textures makes it easy to convert from/to sf::Image, but
...
/// of booleans.
///
/// Like sf::Image, sf::Textures can handle a unique internal
...
/// Usage example:
/// \code
/// // This example shows the most common use of sf::Textures:
/// // drawing a sprite
///
...
///
/// \code
/// // This example shows another common use of sf::Textures:
...
/// \endcode
///
/// Like sf::Shaders that can be used as a raw OpenGL shader,
/// sf::Textures can also be used directly as a raw texture for
/// custom OpenGL geometry.
/// \code
/// sf::Textures::bind(&texture);
