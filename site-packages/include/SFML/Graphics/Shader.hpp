...
////////////////////////////////////////////////////////////
/// \brief Shaders class (vertex, geometry and fragment)
///
////////////////////////////////////////////////////////////
...
public:
    ...
    /// sf::Shaders::CurrentTexture:
    /// \code
    /// shader.setUniform("the_texture", sf::Shaders::CurrentTexture).
    /// \endcode
    ///
    /// \param name    Name of the texture in the shader
    /// \param texture Textures to assign
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// \endcode
    /// \code
    /// shader.setUniform("current", sf::Shaders::CurrentTexture);
    /// \endcode
    ///
    /// \param name Name of the texture in the shader
    ///
    ...
    ///
    /// \deprecated Use setUniform(const std::string&, const Textures&) instead.
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// mix sf::Shaders with OpenGL code.
    ///
    /// \code
    /// sf::Shaders s1, s2;
    /// ...
    ...
    /// sf::Shaders::bind(NULL);
    /// // draw OpenGL stuff that use no shader...
    /// \endcode
    ///
    /// \param shader Shaders to bind, can be null to use no shader
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// any attempt to use sf::Shaders will fail.
    ///
    ...
    /// any attempt to use sf::Shaders geometry shader features will fail.
    ///
...
private:
    ...
    TextureTable m_textures;       ///< Textures variables in the shader, mapped to their location
...
///
/// A sf::Shaders can be composed of either a vertex shader
...
/// sf::Shaders handles different types of uniforms:
...
/// shader.setUniform("overlay", texture);                      // texture is a sf::Textures
/// shader.setUniform("current", sf::Shaders::CurrentTexture);
/// \endcode
///
...
///
/// The special Shaders::CurrentTexture argument maps the
...
///     sf::Textures::update(Window&) to copy its contents to a texture
...
///
/// Like sf::Textures that can be used as a raw OpenGL texture,
/// sf::Shaders can also be used directly as a raw shader for
/// custom OpenGL geometry.
/// \code
/// sf::Shaders::bind(&shader);
